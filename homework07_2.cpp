...
void WriteTOFile(string name, int size, double time)
{
    ofstream ofile;
...
int main()
{
    ...
    //WriteTOFile("Insertion Sort", size, double(end - start) / CLOCKS_PER_SEC);
    copy(arr, arr + size, Testarray);
    ...
    cout << double(end - start) / CLOCKS_PER_SEC << "s" << endl;
    //WriteTOFile("Quick Sort", size, double(end - start) / CLOCKS_PER_SEC);
    copy(arr, arr + size, Testarray);
    ...
    cout << double(end - start) / CLOCKS_PER_SEC << "s" << endl;
    //WriteTOFile("Merge Sort", size, double(end - start) / CLOCKS_PER_SEC);
    copy(arr, arr + size, Testarray);
    ...
    cout << double(end - start) / CLOCKS_PER_SEC << "s" << endl;
    //WriteTOFile("Radix Sort", size, double(end - start) / CLOCKS_PER_SEC);
    copy(arr, arr + size, Testarray);
    ...
    cout << double(end - start) / CLOCKS_PER_SEC << "s" << endl;
    //WriteTOFile("Heap Sort", size, double(end - start) / CLOCKS_PER_SEC);
    copy(arr, arr + size, Testarray);
    ...
    cout << double(end - start) / CLOCKS_PER_SEC << "s" << endl;
    //WriteTOFile("STL sort", size, double(end - start) / CLOCKS_PER_SEC);
    copy(arr, arr + size, Testarray);

    cout << "Stdlib qsort:\n";
    qsort(Testarray, size, sizeof(int), cmpfunc);
    cout << double(end - start) / CLOCKS_PER_SEC << "s" << endl;
    //WriteTOFile("Stdlib qsort", size, double(end - start) / CLOCKS_PER_SEC);
